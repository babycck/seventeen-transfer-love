...
export var ONE_HEART_WORLDS = [
  ...
  },
  {
    id: 'entertainment',
    name: '娱乐圈地下恋',
    desc: '你是他的秘密女友。台上偶遇营业，台下偷偷见面——一场不能被发现的秘密恋爱。',
    promptSuffix: '娱乐圈设定：他是当红偶像/演员，你是圈内幕后工作人员（化妆师/造型师/编剧）。你们的恋情必须严格保密。日常：拍摄现场偶遇、深夜偷偷见面、用工作身份打掩护、躲避狗仔。氛围：甜蜜但提心吊胆的地下恋，公开场合的克制和独处时的热烈形成极致反差。危机：一旦曝光，对他是事业毁灭打击——你们能走多远？'
  },
  {
    id: 'custom',
    name: '✍️ 自定义世界',
