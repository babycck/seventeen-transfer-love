...
export var SECRET_DISCOVERY_EVENTS = [
  ...
  // v5 扩充：+14条
  { key: 'secret_hidden_playlist', text:'你的Spotify隐藏歌单被哥哥无意间在蓝牙连接时看到了——"EXO All-Time Best"。不是最近听的——是最早创建于你十六岁那年。哥哥截图发给你——多打一行字:"我小时候的梦想:成为SM练习生然后出道 见到金珉锡。"你差点把手机摔了。当天晚上他说:"我今天才知道你的审美启蒙比我早——我需要更努力了。"', exposure: 0, flag: 'secretFound' },
  { key: 'secret_photocard_collection', text:'你的抽屉里有一套EXO全套小卡——用卡册一页一页放着——放在宿舍抽屉最里层。队友打扫卫生时不小心翻出来——整整一册——每一张都套了保护膜。队友说:"你对粉丝都没这么精心。"你抢回卡册说这是个人收藏——她们不知道这个"个人"的含义是"从十代留到现在的自己"。', exposure: 0, flag: 'secretFound' },
  { key: 'secret_fanart_notebook', text:'你高中时期的笔记本里画满了金珉锡的肖像——不是粉丝画的水平——是偷偷摸摸在课堂上画的水平。本子被夹在旧书里送去旧物回收——后来他帮你搬宿舍的时候从箱底掉出来了。他翻开——一页一页——看了很久。他说:"你画得比我好——至少你能看出画的是谁。我现在画的你——我不敢给你看。"', exposure: 0, flag: 'secretFound' },
  { key: 'secret_exo_lightstick', text:'你的应援棒收藏柜里有一支EXO的——不是买的——是抽奖中的。你在一个粉丝转发活动中洋洋洒洒写了三百字为什么喜欢金珉锡——用粉丝号而不是艺人号。然后你中奖了。那支应援棒现在还在你的柜子里——放在最里面的角落。偶尔它旁边的SEVENTEEN应援棒会反光——像在提醒你已经到了另一个舞台。', exposure: 1, flag: 'secretFound' },
  { key: 'secret_karaoke_history', text:'你在练歌房的历史记录里全是EXO的歌——系统自动记住了你最爱点的十首。队友说下次团建唱你的记录——你拼命拦住了。后来他带你去唱歌——看到记录后他没有笑——他点了一首EXO的歌——说这首节奏好。然后他认真唱了每一个韩文音节——发音不准但很努力。因为他知道那是你练习生时期听的歌。', exposure: 0, flag: 'secretFound' }
];
